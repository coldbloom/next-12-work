...
function MinuteWheel({ height, value, setValue }) {
   ...
   return (
      <div
         className={s['react-ios-time-picker-minute']}
      ...
      >
         ...
         >
            {hours.map((hourObj, index) => (
               <div
                  key={index}
                  className={s['react-ios-time-picker-cell-minute']}
               ...
               >
                  <div
                     ...
                     // }`}
                     className={cn( s['react-ios-time-picker-cell-inner-minute'], {[s['react-ios-time-picker-cell-inner-selected']]: hourObj.selected})}
