...
function HourFormat({ height, value, setValue, onAmPmChange, setHourFormat, hourFormat }) {
   ...
   return (
      <div
         className={s['react-ios-time-picker-hour-format']}
      ...
      >
         ...
         <div
            ref={mainListRef}
            className={cn({[s['react-ios-time-picker-hour-format-transition']]: showFinalTranslate})}
            ...
            {hours.map((hourObj, index) => (
               ...
               >
                  <div
                     ...
                     //       : ''
                     // }`}
                     className={cn(s['react-ios-time-picker-cell-inner-hour-format'], {[s['react-ios-time-picker-cell-inner-hour-format-selected']]: hourObj.selected})}
